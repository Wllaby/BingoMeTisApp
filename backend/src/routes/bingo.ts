    ...
    if (existingTemplates.length === 0) {
      const defaultTemplates = [
        ...
        },
        {
          name: "Kids",
          description: undefined,
          items: ["Playground", "Toys", "Cartoons", "Ice Cream", "Bedtime Story", "Homework", "Recess", "Birthday Party", "Video Games", "Candy", "Pets", "School Bus", "Lunchbox", "Backpack", "Crayons", "Coloring Book", "Bicycle", "Treehouse", "Sleepover", "Hide and Seek", "Tag", "Jump Rope", "Bubbles", "Stickers", "Stuffed Animal"],
          isCustom: false,
        },
      ];
